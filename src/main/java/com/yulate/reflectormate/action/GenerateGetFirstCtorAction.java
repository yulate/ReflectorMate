...
public class GenerateGetFirstCtorAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        WriteCommandAction.runWriteCommandAction(project, () -> {
            ...
            String codeToInsert = getFirstCtorMethod();
    ...
    private String getFirstCtorMethod() {
        return "public static Constructor<?> getFirstCtor(String name) throws Exception {\n" +
